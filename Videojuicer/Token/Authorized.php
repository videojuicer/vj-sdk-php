<?php
Videojuicer_ClassLoader::load("Videojuicer_Token_Authorized_Exception");
Videojuicer_ClassLoader::load("Videojuicer_Token_Abstract");

class Videojuicer_Token_Authorized extends Videojuicer_Token_Abstract {
	 ...
	 */
	public function __construct($url_encoded, $components = array()) {
		...
		} else throw new Videojuicer_Token_Authorized_Exception("Response format invalid");
	}
